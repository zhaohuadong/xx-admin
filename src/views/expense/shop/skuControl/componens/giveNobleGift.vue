    ...
    <MyDialog :model-value="visibel" :title="titleName" @submit="submit" @toggle="toggle">
      <el-form ref="formRef" :model="form" :rules="giveRule" label-width="auto" mx-auto>
        ...
        <el-form-item label="使用天数:" prop="days">
          ...
          <!-- <el-checkbox-group v-model="form.forever" size="small">
            <el-checkbox label="永久" name="free" />
          </el-checkbox-group> -->
          <el-checkbox
...
import { giveNobleData, giveRule } from '../constants'
const { proxy } = getCurrentInstance()
const emits = defineEmits(['queryTable'])

const [visibel, toggle] = useToggle()
const formRef = ref()
const form = reactive(giveNobleData())
...
const showDialog = (params) => {
  ...
  titleName.value = '贵族赠送'
  Object.assign(form, params || giveNobleData())
