  ...
  <div class="app-container">
    <el-card :body-style="{ paddingBottom: 0 }" class="mySearchBar mb-2">
      <div class="flex items-center justify-between">
        ...
        <MyReturn :modelValue="{ name: 'SpecialPoolUserList' }" />
      </div>
    </el-card>
    <MyProTable
      ref="myProTableRef"
...
<script setup name="SpecialPoolUserListDetails">
import { columnsDetail } from './constants.js'
import { getListApi, deleteApi, batchDeleteApi, batchEditApi } from '@/api/game/specialPoolUserDetails.js'
import { ref } from 'vue'
