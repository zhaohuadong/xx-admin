...
import { getTypeListApi } from '@/api/game/nextPrizePool.js'
import { switchNextApi } from '@/api/game/primary.js'
import { getListApi, deleteNextApi, batchNextDeleteApi, getListStatApi } from '@/api/game/currentAwardPool.js'

import { reactive, ref } from 'vue'

import AddOrEdit from './components/addOrEdit.vue'
import OneClickEditing from '../currentAwardPool/components/OneClickEditing.vue'
...
const getList = (request) => {
  // request.nextConfigId = reactive.nextConfigId
...
function editBatch() {
  // oneClickEditing.value.showDialog()
