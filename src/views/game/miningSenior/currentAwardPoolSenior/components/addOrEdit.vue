    ...
    <el-form ref="formRef" :model="form" :rules="formRule" label-width="auto">
      <el-form-item label="礼物" prop="giftId">
        <el-select v-model="form.giftId" placeholder="请选择礼物" class="w-full">
          <el-option v-for="item in giftOptions.value" :key="item.giftId" :label="item.giftName" :value="item.giftId" />
        </el-select>
      </el-form-item>
...
<script setup>
import { editApi, addApi, getGiftListApi } from '@/api/game/nextCurrentAwardPool.js'
