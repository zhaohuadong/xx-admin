...
<script setup name="CurrentAwardPool">
import { columns, poolList } from './constants.js'
import { getListApi, deleteApi, batchDeleteApi, getListStatApi } from '@/api/game/nextCurrentAwardPool.js'
...
const gitStatList = async (params) => {
  const { data } = await getListStatApi({ type: params })
